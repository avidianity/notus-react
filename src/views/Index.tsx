					...
					<div className='flex flex-wrap items-center'>
						<div className='w-full md:w-4/12 px-12 md:px-4 ml-auto mr-auto mt-48'>
							...
							<div className='block pb-6'>
								<span className='text-xs font-semibold inline-block py-1 px-uppercase rounded-full text-blueGray-500 bg-white uppercase last:mr-0 mr-2 mt-2'>
									Buttons
								</span>
								<span className='text-xs font-semibold inline-block py-1 px-uppercase rounded-full text-blueGray-500 bg-white uppercase last:mr-0 mr-2 mt-2'>
									Inputs
				...
				<div className='justify-center text-center flex flex-wrap mt-24'>
					<div className='w-full md:w-6/12 px-12 md:px-4'>
						...
						<p className='text-lg leading-relaxed mt-4 mb-4 text-blueGray-500'>
							Notus React is a completly new product built using our past experience in web templates. Take the examples we
					...
					<div className='flex flex-wrap justify-center'>
						<div className='w-full md:w-5/12 px-12 md:px-4 ml-auto mr-auto md:mt-64'>
							...
							<p className='text-lg font-light leading-relaxed mt-4 mb-4 text-blueGray-400'>
								...
								is an open source project we wanted to continue this movement too. You can give this version a try to feel
